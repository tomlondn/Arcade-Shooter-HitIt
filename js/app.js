...
const randomObject = () =>
  Object.keys(gameObjects)[
    Math.floor(Math.random() * Object.keys(gameObjects).length)
  ];
...
const gameObjects = {
  square: {
    ...
    init: function () {
      ...
      this.speedX =
        this.speedX * checkFlyDirection(this.x, this.s, canvasWidth);
      this.speedY =
        this.speedY * checkFlyDirection(this.y, this.s, canvasHeight);
  ...
  circle: {
    ...
    init: function () {
      ...
      this.color = randomColor();
      this.speedX =
        this.speedX * checkFlyDirection(this.x, this.r, canvasWidth);
      this.speedY =
        this.speedY * checkFlyDirection(this.y, this.r, canvasHeight);
    ...
    move: function () {
      ...
      collector.forEach((obj, index) => {
        if (
          obj.x - obj.r * 2 > canvasWidth ||
          obj.x - obj.r * 2 < 0 ||
          obj.y - obj.r * 2 > canvasHeight ||
          obj.y < 0 - obj.r * 2
        ) {
          collector.splice(index, 1);
        }
  ...
  rectangle: {
    ...
    init: function () {
      ...
      this.color = randomColor();
      this.speedX =
        this.speedX * checkFlyDirection(this.x, this.w, canvasWidth);
      this.speedY =
        this.speedY * checkFlyDirection(this.y, this.h, canvasHeight);
